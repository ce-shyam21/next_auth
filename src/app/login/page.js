...
// this is the login page customized 
export default function Login() {
  const { status } = useSession();
  const router = useRouter();
// if satet is authencated then send user to hoe page
  ...
  const handleSignIn = (e) => {
    e.preventDefault();
    // email, password are state variable s
  ...
  return (
    <div className={styles.loginContainer}>
      <div className={styles.wrapper}>
        ...
        {/*  this is for the ggogle and git hub sign in copy pase whole fole just chek the link  */}
        <button
